...
function RestockSweet() {
  ...
  const [restockQuantities, setRestockQuantities] = useState({}); // Track quantity input
  ...
  const restockSweet = (id) => {
    ...
    axios.post(`http://localhost:5000/sweets/${id}/restock`, { quantity })
      .then(() => {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold mb-4">Restock Sweets</h2>
      ...
      <table border="1" cellPadding="10">
        <thead>
          <tr>
            <th>ID</th><th>Name</th><th>Category</th><th>Price</th><th>Current Qty</th><th>Restock Qty</th><th>Actions</th>
          </tr>
        </thead>
        <tbody>
